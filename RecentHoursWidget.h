...
#ifndef RECENT_HOURS_WIDGET_H_
#define RECENT_HOURS_WIDGET_H_
...
class RecentHoursWidget : public Wt::WContainerWidget
{

public:
	RecentHoursWidget(const char *conninfo, StudentSession *session, Wt::WContainerWidget *parent = 0);
